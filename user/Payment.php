...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    if(isset($_POST["btnpay"])!="")
    {
        $current_datetime = date('Y-m-d H:i:s');
         $up ="update tbl_service_request set req_status='7' where req_id='".$_GET["rid"]."'";
         $bill="UPDATE tbl_bill SET bill_status = 3, pay_date = '$current_datetime' WHERE bill_id ='".$_GET["bid"]."'";
